  ...
  const location = useLocation();
    ...
    return (
        <div
            ...
            <NavLink to="/" className={`flex flex-col items-center text-sm active:scale-110 transition duration-200`}>
                <FaHome size={22} color={getActiveColor('/')}/>
                <span className="mt-1">Home</span>
            </NavLink>
            <NavLink to="/pages/chat" className={`flex flex-col items-center text-sm active:scale-110 transition duration-200`}>
                <FaCommentDots size={22} color={getActiveColor('/pages/chat')}/>
                <span className="mt-1">Chat</span>
            </NavLink>
            <NavLink to="/pages/about" className={`flex flex-col items-center text-sm active:scale-110 transition duration-200`}>
